...
module RestClient
  ...
  # * :ssl_version specifies the SSL version for the underlying Net::HTTP connection (defaults to 'SSLv3', only available in Ruby 1.9+)
  class Request
    ...
    def initialize args
      ...
      @ssl_version = args[:ssl_version] || 'SSLv3' if RUBY_VERSION >= '1.9'
